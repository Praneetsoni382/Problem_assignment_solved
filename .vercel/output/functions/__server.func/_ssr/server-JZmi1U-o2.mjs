...
import { i as csrfSymbol, n as createCsrfMiddleware } from "./server-JZmi1U-o.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BollF5uY.mjs");
...
var manifest = {
	"8f31eb015edeb0bfed9d050c5721887cba08fe8ceae262675989bcbb1c4edf86": {
		functionName: "generateAiFeedbackServerAction_createServerFn_handler",
		importer: () => import("./ai-feedback-action-c3tBu3eg.mjs")
	},
	"db27bd4a9b7ccc88fd440d5c89db6dadce3f9523ddd6e749d064ca6a17c0dcea": {
		functionName: "getOrCreateSubmissionServerAction_createServerFn_handler",
		importer: () => import("./submission-action-Gf8Em7YO.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DbtMI3nh.mjs").then((n) => n.t),
		import("./start-fHEZB--7.mjs"),
